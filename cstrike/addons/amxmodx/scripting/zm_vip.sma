...
public plugin_init() {
	...
	g_infecthealth = register_cvar("zp_vip_infecthealth", "900")
	...
	g_fall_damage = register_cvar("zp_vip_no_fall_damage", "0")
	g_damage_reward = register_cvar("zp_vip_damage_reward", "400")
	...
	g_menu_close = register_cvar("zp_vip_menu_close", "0")
...
public vip_menu_handler(id, menu, item)
{
	...
	if(g_team[id] & FLAG_A && (!zp_get_user_zombie(id) || zp_get_user_nemesis(id))) return PLUGIN_HANDLED
