...
new infinir_V_MODEL[64] = "models/zm/v_infinitysr.mdl"
new infinir_P_MODEL[64] = "models/zm/p_infinitysr.mdl"
new infinir_W_MODEL[64] = "models/zm/w_infinitysr.mdl"
...
public plugin_init()
{
	register_plugin("[ZP] Extra: Infinitys Red", "1.0", "LARS-DAY[BR]EAKER")
	...
	cvar_dmg_infinir = register_cvar("zp_infinir_dmg", "4.0")
	cvar_recoil_infinir = register_cvar("zp_infinir_recoil", "1.0")
	cvar_clip_infinir = register_cvar("zp_infinir_clip", "20")
	cvar_spd_infinir = register_cvar("zp_infinir_spd", "0.98")
	cvar_infinir_ammo = register_cvar("zp_infinir_ammo", "200")

	g_itemid_infinir = zp_register_extra_item("[Pistol] \rInfinity Red", 6, ZP_TEAM_HUMAN)
...
{
   new id = get_pdata_cbase(weapon, 41)
...
public fw_infinir_WeaponIdle_Post(weapon)
{
	...
	new id = get_pdata_cbase(weapon, m_pPlayer)
